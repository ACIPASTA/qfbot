...
client.on("guildMemberAdd", member => {
  const hosgeldin = new Discord.MessageEmbed()
    ...
    .setDescription("Seni aramız da görmekten onur ve şeref duyuyoruz, QuantumFlare.")
   .setColor("#00ff00")
    .addField("**Sunucu Adresimiz**", "[Tıkla ](https://discord.gg/hSunZXgwuy)")
    .addField(
      "**YouTube kanalımız**",
      "[Tıkla ](https://youtube.com/@acipasta?si=GmlN6ugIEX0Rhw2i)"
    )
